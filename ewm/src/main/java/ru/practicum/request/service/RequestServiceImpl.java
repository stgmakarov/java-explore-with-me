...
public class RequestServiceImpl implements RequestService {
    ...
    private void checkCorrectlyRequest(User user, Event event) {
        ...
        if (event.getParticipantLimit() > 0 && event.getParticipantLimit() <= getConfirmedRequest(event.getId())) {
    ...
    private EventReqStOutDto changeStateRequestWithParticipantLimit(Integer confirmedReqNow,
